package LabExercises.lab11.ex3;
...
public class Organisation {
    public static void main(String[] args) {
        ...
        AdjacencyMatrixGraph<String> adjacencyMatrixGraph = new AdjacencyMatrixGraph<>(N);
        HashMap<String, Integer> hashMap = new HashMap<>();
        for (int i = 0; i < M; i++) {
            String[] input = sc.nextLine().split(" ");
            hashMap.put(input[1], Integer.parseInt(input[0]));
            hashMap.put(input[3], Integer.parseInt(input[2]));
            adjacencyMatrixGraph.addEdge(Integer.parseInt(input[0]), Integer.parseInt(input[2]), Integer.parseInt(input[4]));
        }
        String president = sc.nextLine();
        int sum = 0;
        for (Edge edge : adjacencyMatrixGraph.prim(hashMap.get(president))) {
