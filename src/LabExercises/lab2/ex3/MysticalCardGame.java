...
public class MysticalCardGame {
    public static void startDuel(SLL<Card> firstSorcererCards, SLL<Card> secondSorcererCards) {
        SLLNode<Card> temp1 = firstSorcererCards.getFirst().succ;
        SLLNode<Card> temp2 = secondSorcererCards.getFirst();
        SLLNode<Card> max = firstSorcererCards.getFirst();
        while (temp1 != null) {
            if (max.element.significance() < temp1.element.significance()) {
                max = temp1;
            }
            temp1 = temp1.succ;
        }

        temp1 = firstSorcererCards.getFirst();
        while (temp1 != null) {
            if (temp1.element.getType() == max.element.getType()) {
                firstSorcererCards.delete(temp1);
                break;
            }
            temp1 = temp1.succ;
        }
        ...
        while (temp2 != null) {
            ...
            counter++;
            if (counter == size / 2) {
                secondSorcererCards.insertAfter(max.element, temp2);
                break;
            }
        }
    }
